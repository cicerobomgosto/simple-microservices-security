package br.com.brdev2w.deliveryv1clienteservice.security.filters;

import br.com.brdev2w.deliveryv1clienteservice.service.auth.MyUserDetails;
...
public class JwtUtil {
	...
	public boolean validateJwtToken(String token) {
		try {
			...
			logger.error("Invalid token-cliente");
